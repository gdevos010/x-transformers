...
class NeoMLP(Module):
    ...
    def __init__(
        ...
        *,
        ...
        dim_model,
        depth,
        encoder_kwargs: dict = dict(attn_dim_head=16, heads=4),
    ):
        super().__init__()
        ...
        self.random_fourier = nn.Sequential(
            RandomFourierEmbed(dim_model), nn.Linear(dim_model, dim_model)
        )
        ...
        self.transformer = Encoder(dim=dim_model, depth=depth, **encoder_kwargs)
